    ...
    <div className="min-h-screen flex items-center justify-center bg-neutral-100 dark:bg-[#050505] transition-colors">
      <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 bg-white dark:bg-[#0a0a0a] rounded-2xl shadow-[0_0_40px_-10px_rgba(0,0,0,0.1)] dark:shadow-none overflow-hidden border border-neutral-200 dark:border-neutral-800">
        ...
        <motion.div
          ...
          className="hidden md:flex flex-col items-center justify-center bg-gradient-to-br from-neutral-100 via-neutral-200 to-neutral-50 dark:from-[#0a0a0a] dark:via-neutral-900/50 dark:to-[#0a0a0a]"
        >
        ...
        >
          ...
          <div className="flex flex-col gap-3">
            <button
              ...
              disabled={loading}
              className="flex items-center justify-center gap-2 w-full py-2 rounded-lg border border-gray-300 dark:border-neutral-800 bg-white dark:bg-[#0f0f0f] text-gray-700 dark:text-gray-200 font-medium shadow-sm hover:bg-gray-50 dark:hover:bg-neutral-800/80 transition"
            >
